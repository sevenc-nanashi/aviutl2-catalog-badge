Generated with [vike.dev/new](https://vike.dev/new) ([version 575](https://www.npmjs.com/package/create-vike/v/0.0.575)) using this command:

```sh
bun create vike@latest --vue --hono --cloudflare
```
